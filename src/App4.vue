<template>
    ...
    <ejs-documenteditor ref="documenteditor" id="container_1" :serviceUrl='serviceUrl' :isReadOnly='false'
...
<script setup>
import { DocumentEditorComponent as EjsDocumenteditor, SpellChecker, Print, SfdtExport, WordExport, TextExport, Selection, Search, Editor, ImageResizer, EditorHistory, ContextMenu, OptionsPane, HyperlinkDialog, TableDialog, BookmarkDialog, TableOfContentsDialog, PageSetupDialog, StyleDialog, ListDialog, ParagraphDialog, BulletsAndNumberingDialog, FontDialog, TablePropertiesDialog, BordersAndShadingDialog, TableOptionsDialog, CellOptionsDialog, StylesDialog } from '@syncfusion/ej2-vue-documenteditor';
...
onMounted(function () {
    ...
    //documenteditor.value.ej2Instances.Inject(SpellChecker);
    console.log(documenteditor.value.ej2Instances.spellChecker);
...
provide('SpellChecker', [SpellChecker]);
